...
export class PurchaseAdviceService {
  ...
  private static _toImpact(evaluation: IPurchaseEvaluation): PurchaseImpact | null {
    ...
    return {
      ...
      bestOutfitScore: impact.bestOutfitScore,
      baselineBestScore: impact.baselineBestScore,
      bestOutfitScenarioLabel: evaluation.bestOutfitScenarioLabel,
  ...
  private async _save(
    ...
    const data = {
      ...
      bestOutfitScore: impact?.bestOutfitScore ?? 0,
      baselineBestScore: impact?.baselineBestScore ?? 0,
      bestOutfitScenarioLabel: impact?.bestOutfitScenarioLabel ?? null,
  ...
  private static _toAdviceDto(
    ...
    return {
      ...
      impact: {
        ...
        bestOutfitScore: advice.bestOutfitScore,
        baselineBestScore: advice.baselineBestScore,
        bestOutfitScenarioLabel: advice.bestOutfitScenarioLabel,
